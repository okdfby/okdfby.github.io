...
$(document).ready(function(){
    ...
    $('#multi-div').multiscroll({
        // anchors: ['Дадому', 'Аб нас', 'Праграма', 'Кантакты'],
        loopTop: true,
        loopBottom: true,
        navigation: true,
        navigationTooltips: ['Дадому', 'Аб нас', 'Праграма', 'Кантакты'],
    });
    ...
    $('#carousel-services').carousel({
      interval: 9000 // False if you want to remove auto slide
    });
    ...
    $('#countdown_dashboard').countDown({
        targetDate: {
            // +1 для того, чтобы выровнять счётчик со старым сайтом
            'day': 19+1,
            'month': 4,
            'year': 2019,
            'hour': 0,
